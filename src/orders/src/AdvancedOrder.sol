...
import { GetPriceResponse, ISlinky, ISLINKY_PRECOMPILE_ADDRESS } from "../precompiles/slinky/ISlinky.sol";
import { FutureByIdResponse, IAsync, IASYNC_PRECOMPILE_ADDRESS } from "../precompiles/async/IAsync.sol";
